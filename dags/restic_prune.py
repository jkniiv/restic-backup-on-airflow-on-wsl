...
run_restic_prune = BashOperator(
    task_id='run_restic_prune',
    bash_command=msys2_bash_invocation("restic-execute-pruning-phase"),
    dag=dag,
)
...
run_restic_prune >> run_restic_check >> run_this_last
